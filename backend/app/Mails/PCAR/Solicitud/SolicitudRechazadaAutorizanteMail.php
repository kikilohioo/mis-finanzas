...
class SolicitudRechazadaAutorizanteMail extends Mailable
{
    ...
    public function build()
    {
        return $this->from(env('MAIL_FROM_ADDRESS'), env('MAIL_FROM_NAME'))
            ->view('mails.pcar.solicitud.solicitudRechazadaAutorizante')
            ->subject('[PCAR] Solicitud para circular en área restringida [RECHAZADA]');
    }
}