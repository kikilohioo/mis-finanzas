					...
					<tr>
						<td colspan="2">
							<div style="padding: 12px">
								...
								<b>{{date_format(new DateTime($solicitud->Desde), 'd/m/Y')}}</b>-<b>{{date_format(new DateTime($solicitud->Hasta), 'd/m/Y')}}</b>) ha sido rechazada con el comentario <b>{{$solicitud->ComentariosAprobador}}</b>.<br />
								<br />
								Saludos
							</div>
						</td>
