					...
					<tr>
						<td colspan="2">
							<div style="padding: 12px">
								...
								<br />
								<b>{{$solicitud->Usuario->Nombre}}</b> ha rechazado una solicitud para que el proveedor <b>{{$solicitud->PersonaContacto}}</b> de la empresa <b>{{$solicitud->Empresa}}</b> circule dentro del área restringida del complejo industrial
								...
								<b>{{date_format(new DateTime($solicitud->Hasta), 'd/m/Y')}}</b>) ha sido rechazada con el comentario <b>{{$solicitud->ComentariosAprobador}}</b>.<br />
								<br />
								Saludos
							</div>
						</td>
